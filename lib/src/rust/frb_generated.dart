...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -1567247411;
...
abstract class RustLibApi extends BaseApi {
  Future<CommentItem> crateApiMangalibClientAddComment(
      {required String relationType,
      required PlatformInt64 relationId,
      required String comment,
      PlatformInt64? parentId});

  Future<void> crateApiStorageAddCustomTag(
      {required PlatformInt64 mangaId, required String tagName});

  Future<void> crateApiStorageAddToCustomList(
  ...
  Future<PlatformInt64> crateApiStorageBulkImportBookmarks(
  ...
  Future<void> crateApiStorageClearReadingHistory();

  Future<CustomUserList> crateApiStorageCreateCustomList(
      {required String name, required String color});

  Future<void> crateApiStorageDeleteCustomList({required PlatformInt64 listId});
  ...
  Future<bool> crateApiMangalibClientDeleteMangaBookmark(
      {required PlatformInt64 bookmarkId});

  Future<void> crateApiStorageDeleteReadingHistoryItem(
      {required PlatformInt64 mangaId,
      required String volume,
      required String number});
  ...
  Future<String> crateApiStorageExportMalXml();
  ...
  Future<List<String>> crateApiStorageGetAllCustomTags();
  ...
  Future<List<AppSettingItem>> crateApiStorageGetAllSettings();
  ...
  Future<MangaCollectionDetails> crateApiMangalibClientGetCollectionDetails(
      {required PlatformInt64 collectionId});

  Future<List<MangaCollectionItem>> crateApiMangalibClientGetCollections(
      {required PlatformInt64 page, required String sortBy});

  Future<CommentsData> crateApiMangalibClientGetComments(
      {required String relationType,
      required PlatformInt64 relationId,
      required PlatformInt64 page,
  ...
  Future<List<LibraryEntry>> crateApiStorageGetCustomListEntries(
      {required PlatformInt64 listId});

  Future<List<CustomUserList>> crateApiStorageGetCustomLists();

  Future<List<String>> crateApiStorageGetCustomTags(
      {required PlatformInt64 mangaId});
  ...
  Future<List<MangaSearchResult>> crateApiMangalibClientGetLatestSiteUpdates();
  ...
  Future<Int64List> crateApiStorageGetMangaCustomLists(
      {required PlatformInt64 mangaId});
  ...
  Future<MangaRecapData> crateApiStorageGetMangaRecap();
  ...
  Future<NotificationCountInfo> crateApiMangalibClientGetNotificationCount();

  Future<List<ReadingHistoryItem>> crateApiStorageGetReadingHistory(
      {required PlatformInt64 limit, required PlatformInt64 offset});

  Future<ReadingPosition?> crateApiStorageGetReadingProgress(
      {required PlatformInt64 mangaId});

  Future<ReadingSessionInfo> crateApiStorageGetReadingSessionStats();

  Future<ReadingStatistics> crateApiStorageGetReadingStatistics();

  Future<ReadingStreakInfo> crateApiStorageGetReadingStreak();

  Future<List<RecommendedManga>> crateApiStorageGetRecommendations(
      {required PlatformInt64 limit});

  Future<String?> crateApiStorageGetSetting({required String key});

  Future<List<MangaSearchResult>> crateApiMangalibClientGetTopViews(
      {required String time});

  Future<List<MangaSearchResult>> crateApiMangalibClientGetUserBookmarks(
      {required PlatformInt64 userId, required PlatformInt64 status});

  Future<List<MangaSearchResult>> crateApiMangalibClientGetUserBookmarksPage(
      {required PlatformInt64 userId,
      required PlatformInt64 status,
      required PlatformInt64 page});

  Future<UserDetailedProfile> crateApiMangalibClientGetUserDetailedProfile(
      {required PlatformInt64 userId});

  Future<UserPrivacySettings> crateApiMangalibClientGetUserPrivacy(
      {required PlatformInt64 userId});

  Future<UserProfile> crateApiMangalibClientGetUserProfile(
      {required PlatformInt64 userId});

  Future<bool> crateApiStorageImportBackupJson({required String jsonContent});

  Future<MalImportResult> crateApiStorageImportMalXml(
  ...
  Future<void> crateApiStorageRemoveCustomTag(
      {required PlatformInt64 mangaId, required String tagName});

  Future<void> crateApiStorageRemoveFromCustomList(
      {required PlatformInt64 listId, required PlatformInt64 mangaId});
  ...
  Future<List<UserProfile>> crateApiMangalibClientSearchUsers(
      {required String query});

  void crateApiMangalibClientSetCookies({required String cookies});

  Future<bool> crateApiMangalibClientSetMangaBookmark(
      {required String mediaSlug, required PlatformInt64 statusId});

  Future<void> crateApiStorageSetSetting(
  ...
  Future<bool> crateApiMangalibClientUpdateUserProfile(
      {required PlatformInt64 userId,
      String? username,
  ...
  Future<CommentVoteResult> crateApiMangalibClientVoteComment(
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<CommentItem> crateApiMangalibClientAddComment(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        sse_encode_String(relationType, serializer);
        sse_encode_i_64(relationId, serializer);
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_comment_item,
        decodeErrorData: sse_decode_AnyhowException,
      ),
      constMeta: kCrateApiMangalibClientAddCommentConstMeta,
      argValues: [relationType, relationId, comment, parentId],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiMangalibClientAddCommentConstMeta =>
      const TaskConstMeta(
        debugName: "add_comment",
        argNames: ["relationType", "relationId", "comment", "parentId"],
      );
  ...
  Future<void> crateApiStorageAddCustomTag(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiStorageAddCustomTagConstMeta,
      argValues: [mangaId, tagName],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiStorageAddCustomTagConstMeta =>
      const TaskConstMeta(
        debugName: "add_custom_tag",
        argNames: ["mangaId", "tagName"],
      );
  ...
  Future<void> crateApiStorageAddToCustomList(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_i_64(listId, serializer);
        sse_encode_i_64(mangaId, serializer);
        pdeCallFfi(generalizedFrbRustBinding, serializer,
            funcId: 3, port: port_);
      },
      ...
      constMeta: kCrateApiStorageAddToCustomListConstMeta,
      argValues: [listId, mangaId],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiStorageAddToCustomListConstMeta =>
      const TaskConstMeta(
        debugName: "add_to_custom_list",
        argNames: ["listId", "mangaId"],
      );
  ...
  Future<PlatformInt64> crateApiStorageBulkImportBookmarks(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_list_manga_search_result(items, serializer);
        sse_encode_String(listType, serializer);
        pdeCallFfi(generalizedFrbRustBinding, serializer,
            funcId: 5, port: port_);
      },
      ...
      constMeta: kCrateApiStorageBulkImportBookmarksConstMeta,
      argValues: [items, listType],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiStorageBulkImportBookmarksConstMeta =>
      const TaskConstMeta(
        debugName: "bulk_import_bookmarks",
        argNames: ["items", "listType"],
      );
  ...
  Future<void> crateApiStorageClearReadingHistory() {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiStorageClearReadingHistoryConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiStorageClearReadingHistoryConstMeta =>
      const TaskConstMeta(
        debugName: "clear_reading_history",
        argNames: [],
      );
  ...
  Future<CustomUserList> crateApiStorageCreateCustomList(
    ...
    return handler.executeNormal(NormalTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_custom_user_list,
        decodeErrorData: sse_decode_AnyhowException,
      ),
      constMeta: kCrateApiStorageCreateCustomListConstMeta,
      argValues: [name, color],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiStorageCreateCustomListConstMeta =>
      const TaskConstMeta(
        debugName: "create_custom_list",
        argNames: ["name", "color"],
      );

  @override
  Future<void> crateApiStorageDeleteCustomList(
      {required PlatformInt64 listId}) {
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        final serializer = SseSerializer(generalizedFrbRustBinding);
      ...
      constMeta: kCrateApiStorageDeleteCustomListConstMeta,
      argValues: [listId],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiStorageDeleteCustomListConstMeta =>
      const TaskConstMeta(
        debugName: "delete_custom_list",
        argNames: ["listId"],
      );
  ...
  Future<bool> crateApiMangalibClientDeleteMangaBookmark(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiMangalibClientDeleteMangaBookmarkConstMeta,
      argValues: [bookmarkId],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiMangalibClientDeleteMangaBookmarkConstMeta =>
      const TaskConstMeta(
        debugName: "delete_manga_bookmark",
        argNames: ["bookmarkId"],
      );
  ...
  Future<void> crateApiStorageDeleteReadingHistoryItem(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiStorageDeleteReadingHistoryItemConstMeta,
      argValues: [mangaId, volume, number],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiStorageDeleteReadingHistoryItemConstMeta =>
      const TaskConstMeta(
        debugName: "delete_reading_history_item",
        argNames: ["mangaId", "volume", "number"],
      );
  ...
  Future<String> crateApiStorageExportMalXml() {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiStorageExportMalXmlConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiStorageExportMalXmlConstMeta =>
      const TaskConstMeta(
        debugName: "export_mal_xml",
        argNames: [],
      );
  ...
  Future<List<String>> crateApiStorageGetAllCustomTags() {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiStorageGetAllCustomTagsConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiStorageGetAllCustomTagsConstMeta =>
      const TaskConstMeta(
        debugName: "get_all_custom_tags",
        argNames: [],
      );
  ...
  Future<List<AppSettingItem>> crateApiStorageGetAllSettings() {
    return handler.executeNormal(NormalTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_list_app_setting_item,
        decodeErrorData: sse_decode_AnyhowException,
      ),
      constMeta: kCrateApiStorageGetAllSettingsConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiStorageGetAllSettingsConstMeta =>
      const TaskConstMeta(
  ...
  Future<MangaCollectionDetails> crateApiMangalibClientGetCollectionDetails(
    ...
    return handler.executeNormal(NormalTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_manga_collection_details,
        decodeErrorData: sse_decode_AnyhowException,
      ),
      constMeta: kCrateApiMangalibClientGetCollectionDetailsConstMeta,
      argValues: [collectionId],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiMangalibClientGetCollectionDetailsConstMeta =>
      const TaskConstMeta(
        debugName: "get_collection_details",
  ...
  Future<List<MangaCollectionItem>> crateApiMangalibClientGetCollections(
    ...
    return handler.executeNormal(NormalTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_list_manga_collection_item,
        decodeErrorData: sse_decode_AnyhowException,
      ),
      constMeta: kCrateApiMangalibClientGetCollectionsConstMeta,
      argValues: [page, sortBy],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiMangalibClientGetCollectionsConstMeta =>
      const TaskConstMeta(
        debugName: "get_collections",
        argNames: ["page", "sortBy"],
      );
  ...
  Future<CommentsData> crateApiMangalibClientGetComments(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiMangalibClientGetCommentsConstMeta,
      argValues: [relationType, relationId, page, sort],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiMangalibClientGetCommentsConstMeta =>
      const TaskConstMeta(
        debugName: "get_comments",
        argNames: ["relationType", "relationId", "page", "sort"],
      );
  ...
  Future<List<LibraryEntry>> crateApiStorageGetCustomListEntries(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiStorageGetCustomListEntriesConstMeta,
      argValues: [listId],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiStorageGetCustomListEntriesConstMeta =>
      const TaskConstMeta(
        debugName: "get_custom_list_entries",
        argNames: ["listId"],
      );
  ...
  Future<List<CustomUserList>> crateApiStorageGetCustomLists() {
    return handler.executeNormal(NormalTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_list_custom_user_list,
        decodeErrorData: sse_decode_AnyhowException,
      ),
      constMeta: kCrateApiStorageGetCustomListsConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiStorageGetCustomListsConstMeta =>
      const TaskConstMeta(
        debugName: "get_custom_lists",
        argNames: [],
      );
  ...
  Future<List<String>> crateApiStorageGetCustomTags(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiStorageGetCustomTagsConstMeta,
      argValues: [mangaId],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiStorageGetCustomTagsConstMeta =>
      const TaskConstMeta(
  ...
  Future<List<MangaSearchResult>> crateApiMangalibClientGetLatestSiteUpdates() {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiMangalibClientGetLatestSiteUpdatesConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiMangalibClientGetLatestSiteUpdatesConstMeta =>
      const TaskConstMeta(
        debugName: "get_latest_site_updates",
        argNames: [],
      );
  ...
  Future<Int64List> crateApiStorageGetMangaCustomLists(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiStorageGetMangaCustomListsConstMeta,
      argValues: [mangaId],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiStorageGetMangaCustomListsConstMeta =>
      const TaskConstMeta(
        debugName: "get_manga_custom_lists",
        argNames: ["mangaId"],
      );
  ...
  Future<MangaRecapData> crateApiStorageGetMangaRecap() {
    return handler.executeNormal(NormalTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_manga_recap_data,
        decodeErrorData: sse_decode_AnyhowException,
      ),
      constMeta: kCrateApiStorageGetMangaRecapConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiStorageGetMangaRecapConstMeta =>
      const TaskConstMeta(
        debugName: "get_manga_recap",
        argNames: [],
      );
  ...
  Future<NotificationCountInfo> crateApiMangalibClientGetNotificationCount() {
    return handler.executeNormal(NormalTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_notification_count_info,
        decodeErrorData: sse_decode_AnyhowException,
      ),
      constMeta: kCrateApiMangalibClientGetNotificationCountConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiMangalibClientGetNotificationCountConstMeta =>
      const TaskConstMeta(
        debugName: "get_notification_count",
        argNames: [],
      );
  ...
  Future<List<ReadingHistoryItem>> crateApiStorageGetReadingHistory(
    ...
    return handler.executeNormal(NormalTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_list_reading_history_item,
        decodeErrorData: sse_decode_AnyhowException,
      ),
      constMeta: kCrateApiStorageGetReadingHistoryConstMeta,
      argValues: [limit, offset],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiStorageGetReadingHistoryConstMeta =>
      const TaskConstMeta(
        debugName: "get_reading_history",
  ...
  Future<ReadingSessionInfo> crateApiStorageGetReadingSessionStats() {
    return handler.executeNormal(NormalTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_reading_session_info,
        decodeErrorData: sse_decode_AnyhowException,
      ),
      constMeta: kCrateApiStorageGetReadingSessionStatsConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiStorageGetReadingSessionStatsConstMeta =>
      const TaskConstMeta(
        debugName: "get_reading_session_stats",
        argNames: [],
      );
  ...
  Future<ReadingStatistics> crateApiStorageGetReadingStatistics() {
    return handler.executeNormal(NormalTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_reading_statistics,
        decodeErrorData: sse_decode_AnyhowException,
      ),
      constMeta: kCrateApiStorageGetReadingStatisticsConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiStorageGetReadingStatisticsConstMeta =>
      const TaskConstMeta(
        debugName: "get_reading_statistics",
        argNames: [],
      );
  ...
  Future<List<RecommendedManga>> crateApiStorageGetRecommendations(
    ...
    return handler.executeNormal(NormalTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_list_recommended_manga,
        decodeErrorData: sse_decode_AnyhowException,
      ),
      constMeta: kCrateApiStorageGetRecommendationsConstMeta,
      argValues: [limit],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiStorageGetRecommendationsConstMeta =>
      const TaskConstMeta(
        debugName: "get_recommendations",
        argNames: ["limit"],
      );
  ...
  Future<String?> crateApiStorageGetSetting({required String key}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiStorageGetSettingConstMeta,
      argValues: [key],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiStorageGetSettingConstMeta => const TaskConstMeta(
  ...
  Future<List<MangaSearchResult>> crateApiMangalibClientGetUserBookmarks(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiMangalibClientGetUserBookmarksConstMeta,
      argValues: [userId, status],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiMangalibClientGetUserBookmarksConstMeta =>
      const TaskConstMeta(
        debugName: "get_user_bookmarks",
        argNames: ["userId", "status"],
      );
  ...
  Future<List<MangaSearchResult>> crateApiMangalibClientGetUserBookmarksPage(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiMangalibClientGetUserBookmarksPageConstMeta,
      argValues: [userId, status, page],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiMangalibClientGetUserBookmarksPageConstMeta =>
      const TaskConstMeta(
        debugName: "get_user_bookmarks_page",
        argNames: ["userId", "status", "page"],
      );
  ...
  Future<UserDetailedProfile> crateApiMangalibClientGetUserDetailedProfile(
    ...
    return handler.executeNormal(NormalTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_user_detailed_profile,
        decodeErrorData: sse_decode_AnyhowException,
      ),
      constMeta: kCrateApiMangalibClientGetUserDetailedProfileConstMeta,
      argValues: [userId],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiMangalibClientGetUserDetailedProfileConstMeta =>
      const TaskConstMeta(
        debugName: "get_user_detailed_profile",
        argNames: ["userId"],
      );
  ...
  Future<UserPrivacySettings> crateApiMangalibClientGetUserPrivacy(
    ...
    return handler.executeNormal(NormalTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_user_privacy_settings,
        decodeErrorData: sse_decode_AnyhowException,
      ),
      constMeta: kCrateApiMangalibClientGetUserPrivacyConstMeta,
      argValues: [userId],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiMangalibClientGetUserPrivacyConstMeta =>
      const TaskConstMeta(
        debugName: "get_user_privacy",
        argNames: ["userId"],
      );
  ...
  Future<UserProfile> crateApiMangalibClientGetUserProfile(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiMangalibClientGetUserProfileConstMeta,
      argValues: [userId],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiMangalibClientGetUserProfileConstMeta =>
      const TaskConstMeta(
  ...
  Future<MalImportResult> crateApiStorageImportMalXml(
    ...
    return handler.executeNormal(NormalTask(
      ...
      codec: SseCodec(
        decodeSuccessData: sse_decode_mal_import_result,
        decodeErrorData: sse_decode_AnyhowException,
      ),
      constMeta: kCrateApiStorageImportMalXmlConstMeta,
      argValues: [xmlContent],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiStorageImportMalXmlConstMeta =>
      const TaskConstMeta(
        debugName: "import_mal_xml",
        argNames: ["xmlContent"],
      );
  ...
  Future<void> crateApiStorageRemoveCustomTag(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiStorageRemoveCustomTagConstMeta,
      argValues: [mangaId, tagName],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiStorageRemoveCustomTagConstMeta =>
      const TaskConstMeta(
  ...
  Future<void> crateApiStorageRemoveFromCustomList(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiStorageRemoveFromCustomListConstMeta,
      argValues: [listId, mangaId],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiStorageRemoveFromCustomListConstMeta =>
      const TaskConstMeta(
        debugName: "remove_from_custom_list",
        argNames: ["listId", "mangaId"],
      );
  ...
  Future<List<UserProfile>> crateApiMangalibClientSearchUsers(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiMangalibClientSearchUsersConstMeta,
      argValues: [query],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiMangalibClientSearchUsersConstMeta =>
      const TaskConstMeta(
  ...
  Future<bool> crateApiMangalibClientSetMangaBookmark(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_String(mediaSlug, serializer);
        sse_encode_i_64(statusId, serializer);
        pdeCallFfi(generalizedFrbRustBinding, serializer,
      ...
      constMeta: kCrateApiMangalibClientSetMangaBookmarkConstMeta,
      argValues: [mediaSlug, statusId],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiMangalibClientSetMangaBookmarkConstMeta =>
      const TaskConstMeta(
        debugName: "set_manga_bookmark",
        argNames: ["mediaSlug", "statusId"],
      );
  ...
  Future<void> crateApiStorageSetSetting(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiStorageSetSettingConstMeta,
      argValues: [key, value],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiStorageSetSettingConstMeta => const TaskConstMeta(
  ...
  Future<bool> crateApiMangalibClientUpdateUserPrivacy(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_i_64(userId, serializer);
        sse_encode_i_64(profileVisibility, serializer);
      ...
      constMeta: kCrateApiMangalibClientUpdateUserPrivacyConstMeta,
      argValues: [
        userId,
        profileVisibility,
        statisticsVisibility,
        previousUsernamesVisibility
      ],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiMangalibClientUpdateUserPrivacyConstMeta =>
      const TaskConstMeta(
        debugName: "update_user_privacy",
        argNames: [
          "userId",
          "profileVisibility",
          "statisticsVisibility",
  ...
  Future<bool> crateApiMangalibClientUpdateUserProfile(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        sse_encode_opt_box_autoadd_i_64(gender, serializer);
      ...
      constMeta: kCrateApiMangalibClientUpdateUserProfileConstMeta,
      argValues: [userId, username, gender, about, avatar, cover],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiMangalibClientUpdateUserProfileConstMeta =>
      const TaskConstMeta(
        debugName: "update_user_profile",
        argNames: ["userId", "username", "gender", "about", "avatar", "cover"],
      );
  ...
  Future<CommentVoteResult> crateApiMangalibClientVoteComment(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        sse_encode_i_64(vote, serializer);
        pdeCallFfi(generalizedFrbRustBinding, serializer,
            funcId: 97, port: port_);
      },
      codec: SseCodec(
        decodeSuccessData: sse_decode_comment_vote_result,
        decodeErrorData: sse_decode_AnyhowException,
      ),
      constMeta: kCrateApiMangalibClientVoteCommentConstMeta,
      argValues: [commentId, vote],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiMangalibClientVoteCommentConstMeta =>
      const TaskConstMeta(
        debugName: "vote_comment",
        argNames: ["commentId", "vote"],
      );
  ...
  CommentItem dco_decode_comment_item(dynamic raw) {
    ...
    return CommentItem(
      ...
      rootId: dco_decode_opt_box_autoadd_i_64(arr[2]),
      parentComment: dco_decode_opt_box_autoadd_i_64(arr[3]),
      commentLevel: dco_decode_i_64(arr[4]),
      postPage: dco_decode_opt_box_autoadd_i_64(arr[5]),
      text: dco_decode_String(arr[6]),
      createdAt: dco_decode_String(arr[7]),
      username: dco_decode_String(arr[8]),
      userAvatar: dco_decode_String(arr[9]),
      votesUp: dco_decode_i_64(arr[10]),
      votesDown: dco_decode_i_64(arr[11]),
      userVote: dco_decode_opt_box_autoadd_i_64(arr[12]),
    );
  }
  ...
  CommentVoteResult dco_decode_comment_vote_result(dynamic raw) {
    ...
    return CommentVoteResult(
      ...
      userVote: dco_decode_opt_box_autoadd_i_64(arr[3]),
    );
  }
  ...
  CustomUserList dco_decode_custom_user_list(dynamic raw) {
    ...
    return CustomUserList(
      ...
      itemsCount: dco_decode_i_64(arr[4]),
    );
  }
  ...
  List<AppSettingItem> dco_decode_list_app_setting_item(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_app_setting_item).toList();
  }
  ...
  List<CustomUserList> dco_decode_list_custom_user_list(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_custom_user_list).toList();
  }
  ...
  List<GenreCount> dco_decode_list_genre_count(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_genre_count).toList();
  }
  ...
  List<MangaCollectionItem> dco_decode_list_manga_collection_item(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>)
        .map(dco_decode_manga_collection_item)
        .toList();
  }
  ...
  List<ReadingHistoryItem> dco_decode_list_reading_history_item(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_reading_history_item).toList();
  }

  @protected
  List<RecapMangaItem> dco_decode_list_recap_manga_item(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_recap_manga_item).toList();
  }

  @protected
  List<RecommendedManga> dco_decode_list_recommended_manga(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_recommended_manga).toList();
  }
  ...
  MalImportResult dco_decode_mal_import_result(dynamic raw) {
    ...
    return MalImportResult(
      importedCount: dco_decode_i_64(arr[0]),
      updatedCount: dco_decode_i_64(arr[1]),
      failedCount: dco_decode_i_64(arr[2]),
    );
  }
  ...
  MangaCollectionDetails dco_decode_manga_collection_details(dynamic raw) {
    ...
    return MangaCollectionDetails(
      id: dco_decode_i_64(arr[0]),
      name: dco_decode_String(arr[1]),
      description: dco_decode_String(arr[2]),
      views: dco_decode_i_64(arr[3]),
      favoritesCount: dco_decode_i_64(arr[4]),
      itemsCount: dco_decode_i_64(arr[5]),
      commentsCount: dco_decode_i_64(arr[6]),
      userId: dco_decode_i_64(arr[7]),
      username: dco_decode_String(arr[8]),
      userAvatar: dco_decode_String(arr[9]),
      createdAt: dco_decode_String(arr[10]),
      items: dco_decode_list_manga_search_result(arr[11]),
    );
  }
  ...
  MangaCollectionItem dco_decode_manga_collection_item(dynamic raw) {
    ...
    return MangaCollectionItem(
      ...
      name: dco_decode_String(arr[1]),
      description: dco_decode_String(arr[2]),
      typeName: dco_decode_String(arr[3]),
      views: dco_decode_i_64(arr[4]),
      favoritesCount: dco_decode_i_64(arr[5]),
      itemsCount: dco_decode_i_64(arr[6]),
      commentsCount: dco_decode_i_64(arr[7]),
      votesUp: dco_decode_i_64(arr[8]),
      votesDown: dco_decode_i_64(arr[9]),
      coverUrl: dco_decode_opt_String(arr[10]),
      userId: dco_decode_i_64(arr[11]),
      username: dco_decode_String(arr[12]),
      userAvatar: dco_decode_String(arr[13]),
  ...
  MangaRecapData dco_decode_manga_recap_data(dynamic raw) {
    ...
    return MangaRecapData(
      totalChaptersRead: dco_decode_i_64(arr[0]),
      totalPagesRead: dco_decode_i_64(arr[1]),
      estimatedReadingHours: dco_decode_f_64(arr[2]),
      currentStreak: dco_decode_i_64(arr[3]),
      maxStreak: dco_decode_i_64(arr[4]),
      activeDaysCount: dco_decode_i_64(arr[5]),
      topGenres: dco_decode_list_genre_count(arr[6]),
      topManga: dco_decode_list_recap_manga_item(arr[7]),
      timeOfDay: dco_decode_time_of_day_distribution(arr[8]),
    );
  }
  ...
  NotificationCountInfo dco_decode_notification_count_info(dynamic raw) {
    ...
    return NotificationCountInfo(
      ...
      unreadCards: dco_decode_i_64(arr[1]),
    );
  }
  ...
  ReadingHistoryItem dco_decode_reading_history_item(dynamic raw) {
    ...
    return ReadingHistoryItem(
      ...
      rusName: dco_decode_String(arr[3]),
      coverUrl: dco_decode_String(arr[4]),
      volume: dco_decode_String(arr[5]),
      number: dco_decode_String(arr[6]),
      isCompleted: dco_decode_bool(arr[7]),
      lastReadAt: dco_decode_String(arr[8]),
      totalPages: dco_decode_i_64(arr[9]),
      pageIndex: dco_decode_i_64(arr[10]),
    );
  }
  ...
  ReadingSessionInfo dco_decode_reading_session_info(dynamic raw) {
    ...
    if (arr.length != 5)
      throw Exception('unexpected arr length: expect 5 but see ${arr.length}');
    return ReadingSessionInfo(
      totalReadingSeconds: dco_decode_i_64(arr[0]),
      totalSessions: dco_decode_i_64(arr[1]),
      avgSessionSeconds: dco_decode_i_64(arr[2]),
      todayReadingSeconds: dco_decode_i_64(arr[3]),
      weekReadingSeconds: dco_decode_i_64(arr[4]),
    );
  }
  ...
  ReadingStatistics dco_decode_reading_statistics(dynamic raw) {
    ...
    return ReadingStatistics(
      totalChaptersRead: dco_decode_i_64(arr[0]),
      totalPagesRead: dco_decode_i_64(arr[1]),
      completedMangaCount: dco_decode_i_64(arr[2]),
      inProgressMangaCount: dco_decode_i_64(arr[3]),
      totalLibraryCount: dco_decode_i_64(arr[4]),
      totalDownloadedChapters: dco_decode_i_64(arr[5]),
      currentStreakDays: dco_decode_i_64(arr[6]),
      maxStreakDays: dco_decode_i_64(arr[7]),
      totalActiveDays: dco_decode_i_64(arr[8]),
      topGenres: dco_decode_list_genre_count(arr[9]),
      timeOfDay: dco_decode_time_of_day_distribution(arr[10]),
    );
  }
  ...
  RecapMangaItem dco_decode_recap_manga_item(dynamic raw) {
    ...
    if (arr.length != 5)
      throw Exception('unexpected arr length: expect 5 but see ${arr.length}');
    return RecapMangaItem(
      mangaId: dco_decode_i_64(arr[0]),
      name: dco_decode_String(arr[1]),
      rusName: dco_decode_String(arr[2]),
      coverUrl: dco_decode_String(arr[3]),
      chaptersRead: dco_decode_i_64(arr[4]),
    );
  }
  ...
  RecommendedManga dco_decode_recommended_manga(dynamic raw) {
    ...
    return RecommendedManga(
      ...
      rusName: dco_decode_String(arr[3]),
      coverUrl: dco_decode_String(arr[4]),
      coverThumbUrl: dco_decode_String(arr[5]),
      mangaType: dco_decode_String(arr[6]),
      ratingAverage: dco_decode_String(arr[7]),
  ...
  TimeOfDayDistribution dco_decode_time_of_day_distribution(dynamic raw) {
    ...
    return TimeOfDayDistribution(
      nightCount: dco_decode_i_64(arr[0]),
      morningCount: dco_decode_i_64(arr[1]),
      afternoonCount: dco_decode_i_64(arr[2]),
      eveningCount: dco_decode_i_64(arr[3]),
    );
  }
  ...
  UserDetailedProfile dco_decode_user_detailed_profile(dynamic raw) {
    ...
    return UserDetailedProfile(
      ...
      backgroundUrl: dco_decode_opt_String(arr[3]),
      gender: dco_decode_i_64(arr[4]),
      about: dco_decode_String(arr[5]),
      points: dco_decode_i_64(arr[6]),
      loginStreak: dco_decode_i_64(arr[7]),
      createdAt: dco_decode_opt_String(arr[8]),
      roles: dco_decode_list_String(arr[9]),
      avatarFrameId: dco_decode_opt_box_autoadd_i_64(arr[10]),
      premiumBackgroundId: dco_decode_opt_box_autoadd_i_64(arr[11]),
    );
  }
  ...
  UserPrivacySettings dco_decode_user_privacy_settings(dynamic raw) {
    ...
    return UserPrivacySettings(
      profileVisibility: dco_decode_i_64(arr[0]),
      statisticsVisibility: dco_decode_i_64(arr[1]),
      statisticsSiteIds: dco_decode_list_prim_i_64_strict(arr[2]),
      previousUsernamesVisibility: dco_decode_i_64(arr[3]),
    );
  }
  ...
  UserProfile dco_decode_user_profile(dynamic raw) {
    ...
    return UserProfile(
      ...
      loginStreak: dco_decode_i_64(arr[4]),
    );
  }
  ...
  AppSettingItem sse_decode_app_setting_item(SseDeserializer deserializer) {
    ...
    return AppSettingItem(key: var_key, value: var_value);
  }
  ...
  CommentItem sse_decode_comment_item(SseDeserializer deserializer) {
    ...
    var var_postPage = sse_decode_opt_box_autoadd_i_64(deserializer);
    ...
    var var_userVote = sse_decode_opt_box_autoadd_i_64(deserializer);
    return CommentItem(
        id: var_id,
        userId: var_userId,
        rootId: var_rootId,
  ...
  GenreCount sse_decode_genre_count(SseDeserializer deserializer) {
    ...
    return GenreCount(
        name: var_name, count: var_count, percentage: var_percentage);
  }
  ...
  List<AppSettingItem> sse_decode_list_app_setting_item(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <AppSettingItem>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_app_setting_item(deserializer));
    }
    return ans_;
  }
  ...
  List<CustomUserList> sse_decode_list_custom_user_list(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <CustomUserList>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_custom_user_list(deserializer));
    }
    return ans_;
  }
  ...
  List<GenreCount> sse_decode_list_genre_count(SseDeserializer deserializer) {
    ...
    var ans_ = <GenreCount>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_genre_count(deserializer));
    }
    return ans_;
  }
  ...
  List<MangaCollectionItem> sse_decode_list_manga_collection_item(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <MangaCollectionItem>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_manga_collection_item(deserializer));
    }
    return ans_;
  }
  ...
  List<ReadingHistoryItem> sse_decode_list_reading_history_item(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <ReadingHistoryItem>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_reading_history_item(deserializer));
    }
    return ans_;
  }
  ...
  List<RecapMangaItem> sse_decode_list_recap_manga_item(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <RecapMangaItem>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_recap_manga_item(deserializer));
    }
    return ans_;
  }
  ...
  List<RecommendedManga> sse_decode_list_recommended_manga(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <RecommendedManga>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_recommended_manga(deserializer));
    }
    return ans_;
  }
  ...
  MalImportResult sse_decode_mal_import_result(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_importedCount = sse_decode_i_64(deserializer);
    var var_updatedCount = sse_decode_i_64(deserializer);
  ...
  MangaCollectionDetails sse_decode_manga_collection_details(
    ...
    var var_favoritesCount = sse_decode_i_64(deserializer);
    var var_itemsCount = sse_decode_i_64(deserializer);
    var var_commentsCount = sse_decode_i_64(deserializer);
    var var_userId = sse_decode_i_64(deserializer);
    var var_username = sse_decode_String(deserializer);
    var var_userAvatar = sse_decode_String(deserializer);
    var var_createdAt = sse_decode_String(deserializer);
    var var_items = sse_decode_list_manga_search_result(deserializer);
    return MangaCollectionDetails(
        id: var_id,
        name: var_name,
  ...
  MangaRecapData sse_decode_manga_recap_data(SseDeserializer deserializer) {
    ...
    var var_totalPagesRead = sse_decode_i_64(deserializer);
    var var_estimatedReadingHours = sse_decode_f_64(deserializer);
    var var_currentStreak = sse_decode_i_64(deserializer);
    var var_maxStreak = sse_decode_i_64(deserializer);
    var var_activeDaysCount = sse_decode_i_64(deserializer);
    var var_topGenres = sse_decode_list_genre_count(deserializer);
    var var_topManga = sse_decode_list_recap_manga_item(deserializer);
    var var_timeOfDay = sse_decode_time_of_day_distribution(deserializer);
    return MangaRecapData(
        totalChaptersRead: var_totalChaptersRead,
        totalPagesRead: var_totalPagesRead,
        estimatedReadingHours: var_estimatedReadingHours,
        currentStreak: var_currentStreak,
        maxStreak: var_maxStreak,
        activeDaysCount: var_activeDaysCount,
        topGenres: var_topGenres,
        topManga: var_topManga,
  ...
  NotificationCountInfo sse_decode_notification_count_info(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_count = sse_decode_i_64(deserializer);
    var var_unreadCards = sse_decode_i_64(deserializer);
    return NotificationCountInfo(
        count: var_count, unreadCards: var_unreadCards);
  }
  ...
  ReadingSessionInfo sse_decode_reading_session_info(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_totalReadingSeconds = sse_decode_i_64(deserializer);
    var var_totalSessions = sse_decode_i_64(deserializer);
    var var_avgSessionSeconds = sse_decode_i_64(deserializer);
    var var_todayReadingSeconds = sse_decode_i_64(deserializer);
    var var_weekReadingSeconds = sse_decode_i_64(deserializer);
    return ReadingSessionInfo(
        totalReadingSeconds: var_totalReadingSeconds,
        totalSessions: var_totalSessions,
        avgSessionSeconds: var_avgSessionSeconds,
        todayReadingSeconds: var_todayReadingSeconds,
        weekReadingSeconds: var_weekReadingSeconds);
  }

  @protected
  ReadingStatistics sse_decode_reading_statistics(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_totalChaptersRead = sse_decode_i_64(deserializer);
    var var_totalPagesRead = sse_decode_i_64(deserializer);
    var var_completedMangaCount = sse_decode_i_64(deserializer);
    var var_inProgressMangaCount = sse_decode_i_64(deserializer);
    var var_totalLibraryCount = sse_decode_i_64(deserializer);
    var var_totalDownloadedChapters = sse_decode_i_64(deserializer);
    var var_currentStreakDays = sse_decode_i_64(deserializer);
    var var_maxStreakDays = sse_decode_i_64(deserializer);
    var var_totalActiveDays = sse_decode_i_64(deserializer);
    var var_topGenres = sse_decode_list_genre_count(deserializer);
    var var_timeOfDay = sse_decode_time_of_day_distribution(deserializer);
    return ReadingStatistics(
        totalChaptersRead: var_totalChaptersRead,
        totalPagesRead: var_totalPagesRead,
        completedMangaCount: var_completedMangaCount,
        inProgressMangaCount: var_inProgressMangaCount,
        totalLibraryCount: var_totalLibraryCount,
        totalDownloadedChapters: var_totalDownloadedChapters,
        currentStreakDays: var_currentStreakDays,
        maxStreakDays: var_maxStreakDays,
        totalActiveDays: var_totalActiveDays,
        topGenres: var_topGenres,
        timeOfDay: var_timeOfDay);
  }
  ...
  RecapMangaItem sse_decode_recap_manga_item(SseDeserializer deserializer) {
    ...
    var var_rusName = sse_decode_String(deserializer);
    var var_coverUrl = sse_decode_String(deserializer);
    var var_chaptersRead = sse_decode_i_64(deserializer);
    return RecapMangaItem(
        mangaId: var_mangaId,
        name: var_name,
        rusName: var_rusName,
  ...
  TimeOfDayDistribution sse_decode_time_of_day_distribution(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_nightCount = sse_decode_i_64(deserializer);
    var var_morningCount = sse_decode_i_64(deserializer);
    var var_afternoonCount = sse_decode_i_64(deserializer);
    var var_eveningCount = sse_decode_i_64(deserializer);
    return TimeOfDayDistribution(
        nightCount: var_nightCount,
        morningCount: var_morningCount,
        afternoonCount: var_afternoonCount,
        eveningCount: var_eveningCount);
  }
  ...
  UserDetailedProfile sse_decode_user_detailed_profile(
    ...
    var var_backgroundUrl = sse_decode_opt_String(deserializer);
    ...
    var var_loginStreak = sse_decode_i_64(deserializer);
    var var_createdAt = sse_decode_opt_String(deserializer);
    var var_roles = sse_decode_list_String(deserializer);
    var var_avatarFrameId = sse_decode_opt_box_autoadd_i_64(deserializer);
    var var_premiumBackgroundId = sse_decode_opt_box_autoadd_i_64(deserializer);
    return UserDetailedProfile(
        id: var_id,
        username: var_username,
        avatarUrl: var_avatarUrl,
        backgroundUrl: var_backgroundUrl,
        gender: var_gender,
        about: var_about,
        points: var_points,
        loginStreak: var_loginStreak,
        createdAt: var_createdAt,
        roles: var_roles,
        avatarFrameId: var_avatarFrameId,
        premiumBackgroundId: var_premiumBackgroundId);
  }
  ...
  UserPrivacySettings sse_decode_user_privacy_settings(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_profileVisibility = sse_decode_i_64(deserializer);
    var var_statisticsVisibility = sse_decode_i_64(deserializer);
    var var_statisticsSiteIds = sse_decode_list_prim_i_64_strict(deserializer);
    var var_previousUsernamesVisibility = sse_decode_i_64(deserializer);
    return UserPrivacySettings(
        profileVisibility: var_profileVisibility,
        statisticsVisibility: var_statisticsVisibility,
        statisticsSiteIds: var_statisticsSiteIds,
        previousUsernamesVisibility: var_previousUsernamesVisibility);
  }
  ...
  void sse_encode_comment_item(CommentItem self, SseSerializer serializer) {
    ...
    sse_encode_opt_box_autoadd_i_64(self.postPage, serializer);
    ...
    sse_encode_opt_box_autoadd_i_64(self.userVote, serializer);
  }
  ...
  void sse_encode_list_app_setting_item(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_app_setting_item(item, serializer);
    }
  }
  ...
  void sse_encode_list_custom_user_list(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_custom_user_list(item, serializer);
    }
  }
  ...
  void sse_encode_list_genre_count(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_genre_count(item, serializer);
    }
  }
  ...
  void sse_encode_list_manga_collection_item(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_manga_collection_item(item, serializer);
    }
  }
  ...
  void sse_encode_list_reading_history_item(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_reading_history_item(item, serializer);
    }
  }
  ...
  void sse_encode_list_recap_manga_item(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_recap_manga_item(item, serializer);
    }
  }
  ...
  void sse_encode_list_recommended_manga(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_recommended_manga(item, serializer);
    }
  }
  ...
  void sse_encode_mal_import_result(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_64(self.importedCount, serializer);
    sse_encode_i_64(self.updatedCount, serializer);
  ...
  void sse_encode_manga_collection_details(
    ...
    sse_encode_i_64(self.favoritesCount, serializer);
    sse_encode_i_64(self.itemsCount, serializer);
    sse_encode_i_64(self.commentsCount, serializer);
    sse_encode_i_64(self.userId, serializer);
    sse_encode_String(self.username, serializer);
    sse_encode_String(self.userAvatar, serializer);
    sse_encode_String(self.createdAt, serializer);
    sse_encode_list_manga_search_result(self.items, serializer);
  }
  ...
  void sse_encode_manga_recap_data(
    ...
    sse_encode_i_64(self.totalPagesRead, serializer);
    sse_encode_f_64(self.estimatedReadingHours, serializer);
    sse_encode_i_64(self.currentStreak, serializer);
    sse_encode_i_64(self.maxStreak, serializer);
    sse_encode_i_64(self.activeDaysCount, serializer);
    sse_encode_list_genre_count(self.topGenres, serializer);
    sse_encode_list_recap_manga_item(self.topManga, serializer);
    sse_encode_time_of_day_distribution(self.timeOfDay, serializer);
  }
  ...
  void sse_encode_notification_count_info(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_64(self.count, serializer);
    sse_encode_i_64(self.unreadCards, serializer);
  }
  ...
  void sse_encode_reading_session_info(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_64(self.totalReadingSeconds, serializer);
    sse_encode_i_64(self.totalSessions, serializer);
    sse_encode_i_64(self.avgSessionSeconds, serializer);
    sse_encode_i_64(self.todayReadingSeconds, serializer);
    sse_encode_i_64(self.weekReadingSeconds, serializer);
  }
  ...
  void sse_encode_reading_statistics(
    ...
    sse_encode_i_64(self.totalChaptersRead, serializer);
    sse_encode_i_64(self.totalPagesRead, serializer);
    sse_encode_i_64(self.completedMangaCount, serializer);
    sse_encode_i_64(self.inProgressMangaCount, serializer);
    sse_encode_i_64(self.totalLibraryCount, serializer);
    sse_encode_i_64(self.totalDownloadedChapters, serializer);
    sse_encode_i_64(self.currentStreakDays, serializer);
    sse_encode_i_64(self.maxStreakDays, serializer);
    sse_encode_i_64(self.totalActiveDays, serializer);
    sse_encode_list_genre_count(self.topGenres, serializer);
    sse_encode_time_of_day_distribution(self.timeOfDay, serializer);
  }
  ...
  void sse_encode_recap_manga_item(
    ...
    sse_encode_String(self.rusName, serializer);
    sse_encode_String(self.coverUrl, serializer);
    sse_encode_i_64(self.chaptersRead, serializer);
  }
  ...
  void sse_encode_time_of_day_distribution(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_64(self.nightCount, serializer);
    sse_encode_i_64(self.morningCount, serializer);
    sse_encode_i_64(self.afternoonCount, serializer);
    sse_encode_i_64(self.eveningCount, serializer);
  }
  ...
  void sse_encode_user_detailed_profile(
    ...
    sse_encode_opt_String(self.backgroundUrl, serializer);
    sse_encode_i_64(self.gender, serializer);
    sse_encode_String(self.about, serializer);
    sse_encode_i_64(self.points, serializer);
    sse_encode_i_64(self.loginStreak, serializer);
    sse_encode_opt_String(self.createdAt, serializer);
    sse_encode_list_String(self.roles, serializer);
    sse_encode_opt_box_autoadd_i_64(self.avatarFrameId, serializer);
    sse_encode_opt_box_autoadd_i_64(self.premiumBackgroundId, serializer);
  }
  ...
  void sse_encode_user_privacy_settings(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_64(self.profileVisibility, serializer);
    sse_encode_i_64(self.statisticsVisibility, serializer);
    sse_encode_list_prim_i_64_strict(self.statisticsSiteIds, serializer);
    sse_encode_i_64(self.previousUsernamesVisibility, serializer);
  }
